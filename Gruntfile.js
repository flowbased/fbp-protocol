...
module.exports = function() {
  ...
  this.registerTask('json-to-js', function() {
    ...
    return documentation.getSchemas(function(err, schemas) {
  ...
  return this.registerTask('build-markdown', function() {
    const done = this.async();
    return documentation.renderMessages(function(err, messages) {
      let capabilities;
      if (err) { return done(err); }
      return capabilities = documentation.renderCapabilities(function(err, capabilities) {
        if (err) { return done(err); }
